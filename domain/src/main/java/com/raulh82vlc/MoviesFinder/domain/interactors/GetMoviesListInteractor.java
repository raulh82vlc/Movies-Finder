...
/**
 * Get Movies List Use case
 *
 * @author Raul Hernandez Lopez
 */
public interface GetMoviesListInteractor {

    void execute(String query, GetMoviesListCallback callback) throws InternetConnectionException;

    interface GetMoviesListCallback {
        void onGetMoviesListOK(SearchJSONResults searchJSONResults);

        void onGetMoviesListKO(String error);
    }
}
